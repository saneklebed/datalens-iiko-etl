...
**Уточнение (iikoChain):** целевая система для оболочки — **iikoChain**, не iikoFront. Всё завязано через плагины: нужно «накидать» в папку **Plugins** нужные файлы (манифест, dll, конфиги/ресурсы — по договорённости). Заготовка того, что класть в Plugins, — в `edo_iiko_bridge/iiko_chain_plugins_folder/` (readme + шаблон манифеста).
